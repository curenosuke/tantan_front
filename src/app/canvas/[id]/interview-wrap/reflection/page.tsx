        ...
        <div className="flex-1 p-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-center space-x-4 mb-12">
              ...
              <button className="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 transform hover:scale-110 hover:shadow-lg shadow-md">修正を反映しないで戻る</button>
            </div>
