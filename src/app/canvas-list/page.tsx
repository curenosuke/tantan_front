...
export default function CanvasListPage() {
      ...
      try {
        ...
        if (authResponse.ok) {
          ...
          try {
            ...
            const projectsResponse = await fetch(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/projects`, {
              credentials: 'include',
            })
  ...
  const handleDelete = async (projectId: number) => {
    ...
    try {
              const response = await fetch(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/projects/${projectId}`, {
        method: 'DELETE',
        credentials: 'include',
      })
